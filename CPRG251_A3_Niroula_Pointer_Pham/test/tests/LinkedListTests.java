...
class LinkedListTests {
	...
	/**
	 * Tests if the clear method works
	 */
	...
	/**
	 * Tests if the get size method works
	 */
	@Test
	void testGetSize() {
		this.linkedList.append("a");
	...
	/**
	 * Tests if index not found return -1
	 */
	@Test
